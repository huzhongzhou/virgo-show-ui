...
class Content extends Component<Iprops, Istate>{
    state:Istate = {
        componentitem:{aboutus: { item: [{itemname:'COMPANY PROFILE',itemrouter:'/about_us/company_profile'},{itemname:'OUR TECHNOLOGY',itemrouter:'/about_us/our_technology'},{itemname:'CONTACT US',itemrouter:'/about_us/contact_us'},{itemname:'OUR LOCATION',itemrouter:'/about_us/our_location'}], top: '292px', id: 0 },
